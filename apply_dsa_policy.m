...
%%% File description: function for applying a given DSA policy and determine the state (or states) to transit forward to.

function [ psi_forward, alfa ] = apply_dsa_policy( dsa_policy, possible_forward_states, Power_PSI_cell,...
        wlans, wlan_ix)
    ...
    %   - alfa: array of transition rate tunning parameters
    ...
    switch dsa_policy
            ...
            for state_possible_ix = 1 : num_possible_forward_states    % For each possible forward state    
                ...
                if ch_width > max_ch_width  
                    ...
                    if cca_accomplished
                        ...
                        alfa(1) = 1;   % Just one possible transition
        ...
        case DSA_POLICY_EXPLORER_UNIFORM
            ...
            % *** Handle ALFAs here modifying Q ! ***
            
            num_possible_forward_states_cca = length(possible_forward_states_cca);
            alfa(1:num_possible_forward_states_cca) = 1 / num_possible_forward_states_cca;
        ...
        case DSA_POLICY_EXPLORER_LADDER
            ...
            if ~isempty(possible_forward_states_cca)
                ...
                for psi_forward_aux_ix = 1 : num_possible_forward_states_cca
                    ...
                    alfa(psi_forward_aux_ix) = ch_width / sum_possible_channel_widths;
