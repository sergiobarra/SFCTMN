...
%%% File description: function for finding the global states of a given WLAN system

function [ PSI_cell, num_global_states, PSI ] = identify_global_states( wlans, num_channels_system, num_wlans,...
        access_protocol )
    %IDENTIFY_POSSIBLE_STATES returns the set of global states according a given channel access protocol
    % Input:
    ...
    % Workaround for the case of just one channel in the system. Convert
